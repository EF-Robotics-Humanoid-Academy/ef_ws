...
class UnitreeSdk2Bridge:
    ...
    def __init__(self, mj_model, mj_data):
        ...
        print("[SimBridge] Sport RPC server started.", flush=True)
...
class _SportServer(Server):
    ...
    def Move(self, parameter: str):
        try:
            ...
            print(f"[SportServer] Move vx={vx:.3f} vy={vy:.3f} vyaw={vyaw:.3f}", flush=True)
    ...
    def StopMove(self, parameter: str):
        ...
        print("[SportServer] StopMove", flush=True)
        return 0, ""
