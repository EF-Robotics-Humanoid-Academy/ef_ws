...
configurable_parameters = [{'name': 'camera_namespace',             'default': 'g1', 'description': 'namespace for camera'},
                           ...
                           {'name': 'tf_publish_rate',              'default': '0.5', 'description': 'Rate of publishing static_tf'},
                           {'name': 'diagnostics_period',           'default': '0.0', 'description': 'Rate of publishing diagnostics. 0=Disabled'},
                           {'name': 'decimation_filter.enable',     'default': 'true', 'description': 'Enable decimation filter'},
                           {'name': 'rosbag_filename',              'default': "''", 'description': 'A realsense bagfile to run from as a device'},
                           {'name': 'depth_module.exposure.1',     'default': '7500', 'description': 'Initial value for hdr_merge filter'},
                           {'name': 'depth_module.gain.1',         'default': '16', 'description': ''},
                           {'name': 'depth_module.exposure.2',     'default': '1', 'description': ''},
                           {'name': 'depth_module.gain.2',         'default': '16', 'description': ''},
